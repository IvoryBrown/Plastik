...
public class Extruder {
	...
	public Extruder() {
		...
		this.extruderPalletId = new SimpleStringProperty("");
	}
	...
	public Extruder(String extruderClientId, String extruderIdentification, String extruderStatus,
			...
			String extruderComodityId, String extruderPalletId) {
		this.extruderId = new SimpleStringProperty(String.valueOf(""));
		...
		this.extruderPalletId = new SimpleStringProperty(extruderPalletId);
